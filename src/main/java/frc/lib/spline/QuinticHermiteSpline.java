...
public class QuinticHermiteSpline extends Spline {
    ...
    public Pose getStartPose() {
        return new Pose(
                new Translation(x0, y0),
                new Rotation(dx0, dy0)
        );
    }

    public Pose getEndPose() {
        return new Pose(
                new Translation(x1, y1),
                new Rotation(dx1, dy1)
        );
    }
    ...
    private static void runOptimizationIteration(List<QuinticHermiteSpline> splines) {
        ...
        p2 = new Translation(0, sumDCurvature2(splines)); //middle point is at the current location
        ...
        p1 = new Translation(-kStepSize, sumDCurvature2(splines));
        ...
        p3 = new Translation(kStepSize, sumDCurvature2(splines));
     ...
     */
    private static double fitParabola(Translation p1, Translation p2, Translation p3) {
